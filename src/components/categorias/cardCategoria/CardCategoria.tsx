...
import { MdDelete } from 'react-icons/md'
    ...
    return (
        <div className='rounded-3xl border flex flex-col overflow-hidden justify-between duration-500 bg-gradient-to-b from-[#439da6] to-[#26668b] shadow-md hover:scale-105 hover:shadow-xl mt-6 p-4'>
