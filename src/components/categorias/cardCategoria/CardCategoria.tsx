...
function CardCategorias({ categoria }: CardCategoriaProps) {
  return (
      ...
      <div className="rounded-3xl flex flex-col justify-between duration-500 bg-gradient-to-b from-[#439da6] to-[#26668b] shadow-md hover:scale-105 hover:shadow-xl border-4 border-[#fa769c] border-x-[#FD98B4] m-auto mt-5 p-4 w-[350px] h-[450px]">
