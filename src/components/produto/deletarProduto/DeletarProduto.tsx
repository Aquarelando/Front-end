  ...
  return (
    <div className="container w-1/3 mx-auto">
      ...
      <div className="flex flex-col justify-between overflow-hidden border rounded-2xl">
        ...
        <div className="p-4">
          <p className="text-xl h-full text-center">{produtos.nome}</p>
          <img src={produtos.foto} />
          <p className="text-xl h-full p-3">Descrição: {produtos.descricao}</p>
          <div className="flex">
            <p className="text-xl h-full p-3">
              Validade: {produtos.dataValidade}
            </p>
            <p className="text-xl h-full p-3">
        ...
        <div className="flex">
          <button
            className="w-full py-2 bg-red-400 text-slate-100 hover:bg-red-600"
            onClick={retornar}
          >
            Não
          </button>
          <button
            className="flex items-center justify-center w-full bg-indigo-400 text-slate-100 hover:bg-indigo-600"
