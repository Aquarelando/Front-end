...
function Sobre() {
  return (
    <>
      <div className="mt-[70px] flex mobilemax:hidden">
        <div>
          ...
          <div>
            <img
              src={sobre}
              alt="imagem sobre"
              className="ml-[30px] h-[400px] w-[900px] mt-[190px]"
            />
          </div>
        </div>
        <div>
          <p className="text-4xl text-left">
            Prazer em conhece-los, somos a equipe desenvolvedora do Aquarelando!
          </p>
          <p className="text-[15px] mt-[30px] mb-[1px] text-left">
            Expressamos profunda gratidão a todos que apoiaram o projeto
            "Aquarelando".<br></br> Estamos felizes por concluí-lo e destinar os
            fundos arrecadados a ONGs e escolas de baixa renda.<br></br>{" "}
            Agradecemos por tornarem isso possível e por contribuírem para um
            futuro mais justo e educacionalmente enriquecedor.<br></br> O
            compromisso com causas humanitárias persiste, contando com o apoio
            contínuo.
          </p>
          {/* <Carrossel2/> */}
          ...
          <div className="foto-container mr-4">
            <Link to="https://github.com/littlledan" target="_blank">
              <img
                ...
                className="rounded-3xl size-52 imagem-foto foto-sombra"
              />
            </Link>
            <div className="descricao-holder rounded-l-3xl bg-[#fd98b4]/80">
              <h2>Daniel L.</h2>
              <p>
                Desenvolvedor full stacker com foco em Backend.<br></br>
                <br></br>Clique e saiba mais!
              </p>
            </div>
          </div>
          <div className="foto-container mr-4">
          ...
          <div className="foto-container mr-4">
            <Link
              to="https://github.com/IsabellaCorreiadosantos"
              target="_blank"
            >
              <img
          ...
          <div className="foto-container ml-28 mr-4">
            ...
            <div className="descricao-holder rounded-l-3xl bg-[#fd98b4]/80">
              <h2>Bianca A.</h2>
              <p>
                Dev Back End cursando Engenharia de Software.<br></br>
                <br></br>Clique e saiba mais!
              </p>
            </div>
          </div>
      ...
      <div className="mobilemin:hidden">
        <div className="pt-10 ">
          {" "}
          <p className="flex justify-center text-6xl mb-3">Sobre nós</p>
          <p className="text-4xl text-center">
            Prazer em conhece-los, somos a equipe desenvolvedora do Aquarelando!
          </p>
          <p className="text-[15px] mt-[30px] mb-[1px] text-center">
            Expressamos profunda gratidão a todos que apoiaram o projeto
            "Aquarelando".<br></br> Estamos felizes por concluí-lo e destinar os
            fundos arrecadados a ONGs e escolas de baixa renda.<br></br>{" "}
            Agradecemos por tornarem isso possível e por contribuírem para um
          ...
          <div className="foto-container mr-4">
            <Link to="https://github.com/littlledan" target="_blank">
              <img
                src="https://avatars.githubusercontent.com/u/148507447?v=4"
                alt="imagem do Daniel"
                className="rounded-3xl size-20 imagem-foto foto-sombra"
              />
            </Link>
            <div className="descricao-holder rounded-l-3xl bg-[#fd98b4]/80">
              <h2>Daniel L.</h2>
